    ...
    toExecute.push(function(callback) {
      ...
      doc.validate({ __noPromise: true }, function(error) {
        if (error) {
          ...
          // failed. It's up to the next function to filter out all failed models_mongoose
...
/**
 * Performs [aggregations](http://docs.mongodb.org/manual/applications/aggregation/) on the models_mongoose collection.
 *
