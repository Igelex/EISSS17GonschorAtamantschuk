 ...
 * @param {Boolean} [options.config.autoIndex] set to false to disable automatic index creation for all models_mongoose associated with this connection.
 ...
 * ####Note:
 *
 * _Does not include names of models_mongoose created using `connection.model()`._
 *
 * @api public
 * @return {Array}
 */
